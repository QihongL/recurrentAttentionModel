...
print('\n\nHere\'re the training data: \n' )
print(trainset)
print('Here\'re the dimension of the training data: \n' )
print(#trainset.data)
-- display the 100-th image in dataset
--itorch.image(trainset.data[100])  -- TODO problem  
...
print(trainset[33]) -- load sample number 33.
--itorch.image(trainset[33][1]) -- TODO probelm 
